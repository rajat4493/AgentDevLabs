"""
Band configuration helpers for the RAJOS SDK.
"""
...
class BandsRegistry:
    def __init__(self, raw: Dict[str, Any]) -> None:
        ...
        for band_name, band_cfg in (self._raw.get("bands") or {}).items():
            models: List[BandModel] = []
...
def get_bands_registry() -> BandsRegistry:
    ...
    default_path = Path(__file__).parent / "data" / "bands.json"
    path_str = os.getenv("RAJOS_BANDS_FILE", str(default_path))
